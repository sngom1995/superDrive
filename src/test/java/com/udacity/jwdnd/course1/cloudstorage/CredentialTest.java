...
public class CredentialTest {
    ...
    public void testCreateCredentials() throws InterruptedException {
        ...
        credentialsToSubmit.add(new HomePageObject.CredentialInTest("", "http://sn.com", "sn", "1234567"));
        credentialsToSubmit.add(new HomePageObject.CredentialInTest("", "http://sn1.com", "sn1", "1234567"));
        credentialsToSubmit.add(new HomePageObject.CredentialInTest("", "http://sn2.com", "sn2", "1234567"));
        credentialsToSubmit.add(new HomePageObject.CredentialInTest("", "http://sn3.com", "sn3", "1234567"));
    ...
    private void signUpAndGoToHome(String username) {
        signupPage.createUser("Test", "test", username, "123456");

        //Login
        driver.get("http://localhost:" + port + "/login");
        loginPageObject.authenticate(username, "123456");
